          ...
          children: [
            SvgPicture.asset(
              ...
              color: Theme.of(context).textTheme.headline1.color,
                ...
                .padding(right: 8.w)
                .gestures(onTap: () {
              context.read<CreditsController>().query.reset();
              context.read<CreditsController>().filter();
            }),
...
class ChipSelect extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<TransactionCategory> categories =
        context.select<CreditsController, List<TransactionCategory>>(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  ...
                                  context.read<CreditsController>().filter();
                                  print(
                                      context.read<CreditsController>().query);
                                }),
                                SizedBox(height: AppInsets.insetsPadding.h),
                                Text(
                                  'За месяц',
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Consumer<CreditsController>(
  ...
  Widget build(BuildContext context) {
    return DateRanger(
      ...
      onRangeChanged: (range) {
        context.read<CreditsController>().query.period = [
          range.start,
          range.end
        ];
      },
