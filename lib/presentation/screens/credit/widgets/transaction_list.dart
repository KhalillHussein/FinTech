...
class GroupedList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<CreditsController>(builder: (context, controller, _) {
      return controller.credits.isEmpty || controller.credits == null
          ? Center(
              child: Text(
                'Ничего не найдено',
...
extension DateTimeX on DateTime {
  bool get isLast {
    final last = DateTime(2021, 10, 20);
