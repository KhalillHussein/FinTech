          ...
          children: [
            SvgPicture.asset(
              ...
              color: Theme.of(context).textTheme.headline1.color,
                ...
                .padding(right: 8.w)
                .gestures(onTap: () {
              context.read<DebitsController>().query.reset();
              context.read<DebitsController>().filter();
            }),
...
class ChipSelect extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<TransactionCategory> categories =
        context.select<DebitsController, List<TransactionCategory>>(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  ...
                                  context.read<DebitsController>().filter();
                                  print(context.read<DebitsController>().query);
                                }),
                                SizedBox(height: AppInsets.insetsPadding.h),
                                Text(
                                  'За месяц',
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Consumer<DebitsController>(
  ...
  Widget build(BuildContext context) {
    return DateRanger(
      ...
      onRangeChanged: (range) {
        context.read<DebitsController>().query.period = [
          range.start,
          range.end
        ];
      },
